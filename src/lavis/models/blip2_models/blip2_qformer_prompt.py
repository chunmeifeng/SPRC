...
@registry.register_model("blip2_cir_prompt")
class Blip2QformerPrompt(Blip2Base):
    """
    ...
    def forward(self, samples):
        ...
        return fusion_output.last_hidden_state[:, : query_tokens.size(1), :]
    ...
    @torch.no_grad()
    def inference(self, reference_embeds, text):
