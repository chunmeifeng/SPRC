...
@registry.register_model("blip2_cir_z_learn_pos_align")
class Blip2QformerCirZLearnPosAlign(Blip2Base):
    """
    ...
    def forward(self, samples):
        ...
        loss_align = F.mse_loss(fusion_output.last_hidden_state[:, : query_tokens.size(1), :].mean(1), 
                                text_only_output.last_hidden_state[:, 1 : 33, :].clone().detach().mean(1))
